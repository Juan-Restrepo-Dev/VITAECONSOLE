...
"""
    ...
    def on_mouse_move(self) -> None:
        table = self.query_one(DataTable)
        self.query_one("#colcordi",Input).value = str(table.hover_column)
    ...
    def render(self):
        self.query_one("#colcordi",Input).value = str(self.datasd)
        r = self.query_one("#colcordi",Input).value
        return Text(str(r))
